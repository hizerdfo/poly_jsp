...
<%
	...
	String memberId = (String) adminsession.getAttribute("memberId"); 
...
<!-- 하트 이미지 삽입 -->
    ...
    <div class="admin-button-container">
      <div class="admin-button-style">
        <a href="personalEdit.jsp" style="color: white; text-decoration: none;">개인정보 조회</a>
      </div>
      <div class="admin-button-style">
